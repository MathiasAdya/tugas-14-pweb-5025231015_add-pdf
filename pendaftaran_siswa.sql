...
ALTER TABLE calon_siswa
ADD COLUMN id_pegawai INT(11) DEFAULT NULL,
ADD CONSTRAINT fk_calon_siswa_pegawai FOREIGN KEY (id_pegawai) REFERENCES pegawai(id) ON DELETE SET NULL ON UPDATE CASCADE;
